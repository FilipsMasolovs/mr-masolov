...
export default class Skills extends React.Component {
  ...
  render() {
    const data = {
      ...
      react:
        "<strong>React</strong> (also known as <strong>React.js</strong> or <strong>ReactJS</strong>) is an open-source, front end, JavaScript library for building user interfaces or UI components. It is maintained by Facebook and a community of individual developers and companies. React can be used as a base in the development of single-page or mobile applications.",
      ...
      github:
        "<strong>GitHub, Inc.</strong> is a provider of Internet hosting for software development and version control using Git. It offers the distributed version control and source code management (SCM) functionality of Git, plus its own features.",
      ...
      gitlab:
        "<strong>GitLab</strong> is a web-based DevOps lifecycle tool that provides a Git-repository manager providing wiki, issue-tracking and continuous integration and deployment pipeline features, using an open-source license, developed by GitLab Inc.",
      sketch:
        "<strong>Sketch</strong> is a vector graphics editor for macOS developed by the Dutch company Sketch B.V. It is primarily used for user interface and user experience design of websites and mobile apps and does not include print design features.",
    };
        ...
        <div className="mr-masolov-skills">
          <div className="mr-masolov-skills--logos">
            <img
              src={HTML}
              alt="HTML5"
              onClick={() => this.setState({ skill: "html" })}
            />
            <img
              src={CSS}
              alt="CSS3"
              onClick={() => this.setState({ skill: "css" })}
            />
            <img
              src={JS}
              alt="JavaScript"
              onClick={() => this.setState({ skill: "js" })}
            />
            <img
              src={REACT}
              alt="React.JS"
              onClick={() => this.setState({ skill: "react" })}
            />
            <img
              src={VUE}
              alt="Vue.JS"
              onClick={() => this.setState({ skill: "vue" })}
            />
            <img
              src={GITHUB}
              alt="GitHub"
              onClick={() => this.setState({ skill: "github" })}
            />
            <img
              src={WP}
              alt="WordPress"
              onClick={() => this.setState({ skill: "wp" })}
            />
            <img
              src={PYTHON}
              alt="Python"
              onClick={() => this.setState({ skill: "python" })}
            />
            <img
              src={GITLAB}
              alt="GitLab"
              onClick={() => this.setState({ skill: "gitlab" })}
            />
            <img
              src={SKETCH}
              alt="Sketch"
              onClick={() => this.setState({ skill: "sketch" })}
            />
          </div>
